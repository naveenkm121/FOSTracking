...
public class GPSTracker extends Service implements LocationListener {
        ...
        try {
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                ...
                if (isNetworkEnabled) {
                    ...
                    DebugHandler.Log("GPSTracker isNetworkEnabled");
                ...
                if (isGPSEnabled) {
                    if (location == null) {
                        ...
                        DebugHandler.Log("GPSTracker isGPSEnabled");
                        if (locationManager != null) {
    ...
    public void onLocationChanged(Location location) {
        DebugHandler.Log("GPSTraker ::"+location.getLatitude() +"log::"+location.getLatitude());
    }
